...
🔴 RULE 2: XỬ LÝ / XỬ PHẠT VI PHẠM (NĐ 106 + 189):
   ...
   - BẮT BUỘC trả lời theo form sau:
      ...
      *Logic:* So sánh Mức phạt tiền Cá nhân (X) với thẩm quyền của các chức danh và kiểm tra thẩm quyền được phạt bổ sung hoặc biện pháp KPHQ (tại điều 5 và điều 8 Nghị định 189/2025/NĐ-CP).
